...
class DataTransformation:
    ...
    def get_transformer_obj(self):
        '''
        This function is responsible based on different data types
        '''
        try:
            ...
            cat_pipeline = Pipeline(
                steps = [
                    ...
                    ('one_hot_encoder',OneHotEncoder()), #target guided encoder if more categories are there
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info(f"appplying preprocessing object on training and test data")
